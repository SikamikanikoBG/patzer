...
const CODE_KEYS: Record<string, string> = {
  ...
  invite_required: 'auth.errInviteRequired',
  invite_invalid: 'auth.errInviteInvalid',
  invite_expired: 'auth.errInviteExpired',
  invite_used_up: 'auth.errInviteUsedUp',
  invite_revoked: 'auth.errInviteRevoked',
