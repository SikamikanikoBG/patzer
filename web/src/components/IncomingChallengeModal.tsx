            ...
            <div className="space-y-4 p-5">
              ...
              <div className="grid grid-cols-2 gap-2 text-sm">
                <div className="rounded-lg bg-ink-100 px-3 py-2 dark:bg-ink-800">
                  <div className="text-[10px] uppercase tracking-wide text-ink-500">{t('play.color')}</div>
                  <div className="font-medium capitalize">{c.color === 'random' ? t('play.random') : t(`play.${c.color}`)}</div>
                </div>
                <div className="rounded-lg bg-ink-100 px-3 py-2 dark:bg-ink-800">
                  <div className="text-[10px] uppercase tracking-wide text-ink-500">{t('play.timeControl')}</div>
